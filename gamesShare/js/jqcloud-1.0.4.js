		...
		var drawWordCloud = function() {
			...
			var hitTest = function(elem, other_elems) {
				...
				var overlapping = function(a, b) {
					if (Math.abs(2.0 * a.offsetLeft + a.offsetWidth - 2.0 * b.offsetLeft - b.offsetWidth) < (a.offsetWidth + b.offsetWidth) * 1.1) {
						if (Math.abs(2.0 * a.offsetTop + a.offsetHeight - 2.0 * b.offsetTop - b.offsetHeight) < (a.offsetHeight + b.offsetHeight) * 1.1) {
							return true;
						}
					}
					return false;
			...
			var drawOneWord = function(index, word) {
				...
				if (word_array[0].weight > word_array[word_array.length - 1].weight) {
					...
					weight = Math.round((word.weight - word_array[word_array.length - 1].weight) /
						(word_array[0].weight - word_array[word_array.length - 1].weight) * 1.0) + 1;
				}
