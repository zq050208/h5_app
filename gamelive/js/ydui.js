...
;(function () {
    ...
    function FastClick(layer, options) {
        ...
        if (deviceIsAndroid) {
            layer.addEventListener('mouseover', this.onMouse, {passive:false});
            layer.addEventListener('mousedown', this.onMouse, {passive:false});
            layer.addEventListener('mouseup', this.onMouse, {passive:false});
        }

        layer.addEventListener('click', this.onClick, {passive:false});
